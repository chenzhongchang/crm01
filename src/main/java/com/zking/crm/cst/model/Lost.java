package com.zking.crm.cst.model;
...
public class Lost {
    ...
    public Lost(Long lstId, String lstCustNo, String lstCustName, Long lstCustManagerId, String lstCustManagerName, Date lstLastOrderDate, Date lstLostDate, String lstDelay, String lstReason, String lstStatus) {
        this.lstId = lstId;
